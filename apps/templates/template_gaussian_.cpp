...
#pragma HLS pipeline II=1
    x1 = mul16s_"mul1"(w.pix[3][3], 16);
    x2 = mul16s_"mul2"(w.pix[2][2], 5);
    x3 = mul16s_"mul2"(w.pix[2][3], 5);
    x4 = mul16s_"mul2"(w.pix[2][4], 5);
    x5 = mul16s_"mul2"(w.pix[3][2], 5);
    x6 = mul16s_"mul2"(w.pix[3][4], 5);
    x7 = mul16s_"mul2"(w.pix[4][2], 5);
    x8 = mul16s_"mul2"(w.pix[4][3], 5);
    x9 = mul16s_"mul2"(w.pix[4][4], 5);
    x10 = mul16s_"mul3"(w.pix[1][2], -3);
    x11 = mul16s_"mul3"(w.pix[1][3], -3);
    x12 = mul16s_"mul3"(w.pix[1][4], -3);
    x13 = mul16s_"mul3"(w.pix[2][1], -3);
    x14 = mul16s_"mul3"(w.pix[2][5], -3);
    x15 = mul16s_"mul3"(w.pix[3][1], -3);
    x16 = mul16s_"mul3"(w.pix[3][5], -3);
    x17 = mul16s_"mul3"(w.pix[4][1], -3);
    x18 = mul16s_"mul3"(w.pix[4][5], -3);
    x19 = mul16s_"mul3"(w.pix[5][2], -3);
    x20 = mul16s_"mul3"(w.pix[5][3], -3);
    x21 = mul16s_"mul3"(w.pix[5][4], -3);
    x22 = mul16s_"mul4"(w.pix[1][1], -2);
    x23 = mul16s_"mul4"(w.pix[1][5], -2);
    x24 = mul16s_"mul4"(w.pix[5][1], -2);
    x25 = mul16s_"mul4"(w.pix[5][5], -2);
