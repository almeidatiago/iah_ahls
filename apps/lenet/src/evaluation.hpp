...
public:
    ...
    void print(ofstream &MyFile){
        MyFile <<"Accuracy Evaluation Results\n";
        MyFile << "=======================================\n";
        MyFile <<"\tAverage System Accuracy(%): "<< _avgAccuray*100 << "\n";
        MyFile <<"\tSystem Error(%)           : "<< _errRate*100 << "\n";
        MyFile <<"\tPrecision (Micro)(%)      : "<< _precisionMicro*100 << "\n";
        MyFile <<"\tRecall (Micro)(%)         : "<< _recallMicro*100 << "\n";
        MyFile <<"\tFscore (Micro)(%)         : "<< _fscoreMicro*100 << "\n";
        MyFile <<"\tPrecision (Macro)(%)      : "<< _precisionMacro*100 << "\n";
        MyFile <<"\tRecall (Macro)(%)         : "<< _recallMacro*100 << "\n";
        MyFile <<"\tFscore (Macro)(%)         : "<< _fscoreMacro*100 << "\n";
    }
};
